  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end" data-testid="card-editor-panel">
      <button
        ...
        onClick={onClose}
      />
      <aside className="relative flex h-full w-full max-w-md flex-col border-l border-[var(--border-subtle)] bg-white shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="flex flex-1 flex-col gap-4 overflow-y-auto px-5 py-5">
          <label className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="rounded-md border border-[var(--border-subtle)] px-3 py-2 font-[family-name:var(--font-display)] text-lg font-semibold text-[var(--dark-navy)] outline-none focus:border-[var(--blue-primary)]"
            />
          </label>
